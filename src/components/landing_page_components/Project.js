...
function Project({ title, subtitle, text, image, button_color, github_link, demo_link, text_color, demo_button }) {
  return (
    <div className='projects-project'>
        ...
        <div className='project-button-row'>
            ...
            <div><Link to={demo_link} target="_blank" ><button className='project-button-demo' style={{ '--button-background-color': button_color, color: "var(--color-text)"}}>{demo_button}</button></Link></div>
        </div>
    </div>
  )
}
