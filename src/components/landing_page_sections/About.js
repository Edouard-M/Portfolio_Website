        ...
        <div className='about-main'>
            ...
            <div className='about-column-2'>
                ...
                <div className='about-sublist'>
                    ...
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>Degree:</span> Master (2018 - 2023)</li></Reveal>
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>City:</span> Paris, France</li></Reveal>
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>Email:</span> edouard.mignien@gmail.com</li></Reveal>
                    </div>
                    <div className='about-subcolumn'>
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>Diploma:</span> Software Engineer</li></Reveal>
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>School:</span> ECE Paris - Engineering School</li></Reveal>
                    <Reveal><li style={{"margin-bottom":"5px"}}> <span className='about-bold'>Phone:</span> (+33) 6 73 60 98 81</li></Reveal>
                    </div>
                </div>
            </div>
        </div>
