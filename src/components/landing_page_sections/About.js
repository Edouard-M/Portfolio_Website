            ...
            <div className='about-column-2'>
                ...
                <div className='about-sublist'>
                    <div className='about-subcolumn'>
                        <li> <span className='about-bold'>Degree:</span> Master (2018 - 2023)</li>
                        <li> <span className='about-bold'>City:</span> Paris, France</li>
                        <li> <span className='about-bold'>Email:</span> edouard.mignien@gmail.com</li>
                    </div>
                    <div className='about-subcolumn'>
                        <li> <span className='about-bold'>Diploma:</span> Software Engineer</li>
                        <li> <span className='about-bold'>School:</span> ECE Paris - Engineering School</li>
                        <li> <span className='about-bold'>Phone:</span> (+33) 6 73 60 98 81</li>
                    </div>
                </div>
            </div>
        </div>
